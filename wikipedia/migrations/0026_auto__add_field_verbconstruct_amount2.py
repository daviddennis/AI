...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.amount2'
        db.add_column(u'wikipedia_verbconstruct', 'amount2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='amount_2_set', null=True, to=orm['wikipedia.Amount']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.amount2'
        db.delete_column(u'wikipedia_verbconstruct', 'amount2_id')
