...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.quantifier'
        db.add_column(u'wikipedia_group', 'quantifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Quantifier'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.quantifier'
        db.delete_column(u'wikipedia_group', 'quantifier_id')
