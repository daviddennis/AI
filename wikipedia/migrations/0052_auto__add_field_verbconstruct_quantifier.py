...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.quantifier'
        db.add_column(u'wikipedia_verbconstruct', 'quantifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vc_quant_set', null=True, to=orm['wikipedia.Quantifier']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.quantifier'
        db.delete_column(u'wikipedia_verbconstruct', 'quantifier_id')
