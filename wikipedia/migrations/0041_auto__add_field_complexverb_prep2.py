...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComplexVerb.prep2'
        db.add_column(u'wikipedia_complexverb', 'prep2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prep2_set', null=True, to=orm['wikipedia.Preposition']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComplexVerb.prep2'
        db.delete_column(u'wikipedia_complexverb', 'prep2_id')
