...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.verb_construct2'
        db.add_column(u'wikipedia_verbconstruct', 'verb_construct2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vc_2_set', null=True, to=orm['wikipedia.VerbConstruct']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.verb_construct2'
        db.delete_column(u'wikipedia_verbconstruct', 'verb_construct2_id')
