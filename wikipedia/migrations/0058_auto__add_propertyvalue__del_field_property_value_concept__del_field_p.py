...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wikipedia_propertyvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prop_value_c_set', null=True, to=orm['wikipedia.Concept'])),
            ('amount', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prop_amount_set', null=True, to=orm['wikipedia.Amount'])),
        ))
        db.send_create_signal(u'wikipedia', ['PropertyValue'])
        ...
        # Deleting field 'Property.value_concept'
        db.delete_column(u'wikipedia_property', 'value_concept_id')

        # Deleting field 'Property.value_amount'
        db.delete_column(u'wikipedia_property', 'value_amount_id')

        # Adding field 'Property.sub_prop'
        db.add_column(u'wikipedia_property', 'sub_prop',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Property'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PropertyValue'
        db.delete_table(u'wikipedia_propertyvalue')

        # Removing M2M table for field prop on 'PropertyValue'
        db.delete_table('wikipedia_propertyvalue_prop')

        # Adding field 'Property.value_concept'
        db.add_column(u'wikipedia_property', 'value_concept',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='prop_value_set', null=True, to=orm['wikipedia.Concept'], blank=True),
                      keep_default=False)

        # Adding field 'Property.value_amount'
        db.add_column(u'wikipedia_property', 'value_amount',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='prop_amount_set', null=True, to=orm['wikipedia.Amount'], blank=True),
                      keep_default=False)

        # Deleting field 'Property.sub_prop'
        db.delete_column(u'wikipedia_property', 'sub_prop_id')
    ...
    models = {
        ...
        u'wikipedia.propertyvalue': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prop': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['wikipedia.Property']", 'symmetrical': 'False'})
        },
