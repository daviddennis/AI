...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AssertionValue'
        db.create_table(u'wikipedia_assertionvalue', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ass_c_value_set', null=True, to=orm['wikipedia.Concept'])),
            ('adj', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ass_adj_value_set', null=True, to=orm['wikipedia.Adjective'])),
        ))
        db.send_create_signal(u'wikipedia', ['AssertionValue'])

        # Adding M2M table for field assertion on 'AssertionValue'
        db.create_table(u'wikipedia_assertionvalue_assertion', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('assertionvalue', models.ForeignKey(orm[u'wikipedia.assertionvalue'], null=False)),
            ('assertion', models.ForeignKey(orm[u'wikipedia.assertion'], null=False))
        ))
        db.create_unique(u'wikipedia_assertionvalue_assertion', ['assertionvalue_id', 'assertion_id'])


    def backwards(self, orm):
        # Deleting model 'AssertionValue'
        db.delete_table(u'wikipedia_assertionvalue')

        # Removing M2M table for field assertion on 'AssertionValue'
        db.delete_table('wikipedia_assertionvalue_assertion')
    ...
    models = {
        ...
        u'wikipedia.assertionvalue': {
            ...
            'assertion': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'ass_value_set'", 'symmetrical': 'False', 'to': u"orm['wikipedia.Assertion']"}),
