...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wikipedia_definition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Concept'])),
            ('vc', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='def_vc_set', null=True, to=orm['wikipedia.VerbConstruct'])),
            ('pc', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='def_pc_set', null=True, to=orm['wikipedia.PrepConstruct'])),
            ('ass', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='def_ass_set', null=True, to=orm['wikipedia.Assertion'])),
            ('prop', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='def_prop_set', null=True, to=orm['wikipedia.Assertion'])),
        ))
        db.send_create_signal(u'wikipedia', ['Definition'])


    def backwards(self, orm):
        # Deleting model 'Definition'
        db.delete_table(u'wikipedia_definition')
    ...
    models = {
        ...
        u'wikipedia.category': {
            ...
            'qf_s': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['wikipedia.QuestionFragment']", 'null': 'True', 'blank': 'True'})
        },
        ...
        u'wikipedia.definition': {
            'Meta': {'object_name': 'Definition'},
            'ass': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'def_ass_set'", 'null': 'True', 'to': u"orm['wikipedia.Assertion']"}),
            'concept': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wikipedia.Concept']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'def_pc_set'", 'null': 'True', 'to': u"orm['wikipedia.PrepConstruct']"}),
            'prop': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'def_prop_set'", 'null': 'True', 'to': u"orm['wikipedia.Assertion']"}),
            'vc': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'def_vc_set'", 'null': 'True', 'to': u"orm['wikipedia.VerbConstruct']"})
        },
        u'wikipedia.entity': {
        ...
        u'wikipedia.property': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'prop_parent_set'", 'null': 'True', 'to': u"orm['wikipedia.Concept']"}),
            'parent_vc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wikipedia.VerbConstruct']", 'null': 'True', 'blank': 'True'}),
        ...
        u'wikipedia.verbconstruct': {
            ...
            'assertion2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'vc_adj_2_set'", 'null': 'True', 'to': u"orm['wikipedia.Assertion']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'property1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'vc_prop_1_set'", 'null': 'True', 'to': u"orm['wikipedia.Property']"}),
