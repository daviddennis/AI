...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Concept', fields ['name']
        db.create_index(u'wikipedia_concept', ['name'])


    def backwards(self, orm):
        # Removing index on 'Concept', fields ['name']
        db.delete_index(u'wikipedia_concept', ['name'])
