...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Alias'
        db.create_table(u'wikipedia_alias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alias_1_set', to=orm['wikipedia.Concept'])),
            ('concept2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='alias_2_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Alias'])


    def backwards(self, orm):
        # Deleting model 'Alias'
        db.delete_table(u'wikipedia_alias')
