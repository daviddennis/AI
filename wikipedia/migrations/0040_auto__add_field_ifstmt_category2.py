...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IfStmt.category2'
        db.add_column(u'wikipedia_ifstmt', 'category2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='category_2_set', null=True, to=orm['wikipedia.Category']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IfStmt.category2'
        db.delete_column(u'wikipedia_ifstmt', 'category2_id')
