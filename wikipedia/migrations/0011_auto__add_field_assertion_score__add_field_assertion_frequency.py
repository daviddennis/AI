...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assertion.score'
        db.add_column(u'wikipedia_assertion', 'score',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Assertion.frequency'
        db.add_column(u'wikipedia_assertion', 'frequency',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assertion.score'
        db.delete_column(u'wikipedia_assertion', 'score')

        # Deleting field 'Assertion.frequency'
        db.delete_column(u'wikipedia_assertion', 'frequency')
