...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Preposition'
        db.create_table(u'wikipedia_preposition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
        ))
        db.send_create_signal(u'wikipedia', ['Preposition'])


    def backwards(self, orm):
        # Deleting model 'Preposition'
        db.delete_table(u'wikipedia_preposition')
