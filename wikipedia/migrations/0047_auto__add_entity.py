...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Entity'
        db.create_table(u'wikipedia_entity', (
            ...
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='entity_set', null=True, to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Entity'])


    def backwards(self, orm):
        # Deleting model 'Entity'
        db.delete_table(u'wikipedia_entity')
