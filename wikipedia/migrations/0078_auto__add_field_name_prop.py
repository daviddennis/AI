...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Name.prop'
        db.add_column(u'wikipedia_name', 'prop',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_prop_set', null=True, to=orm['wikipedia.Property']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Name.prop'
        db.delete_column(u'wikipedia_name', 'prop_id')
