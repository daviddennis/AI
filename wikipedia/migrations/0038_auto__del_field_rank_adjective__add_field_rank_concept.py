...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Rank.adjective'
        db.delete_column(u'wikipedia_rank', 'adjective_id')

        # Adding field 'Rank.concept'
        db.add_column(u'wikipedia_rank', 'concept',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Concept'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Rank.adjective'
        db.add_column(u'wikipedia_rank', 'adjective',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Adjective'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Rank.concept'
        db.delete_column(u'wikipedia_rank', 'concept_id')
