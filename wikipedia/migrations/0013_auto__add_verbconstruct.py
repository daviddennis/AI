...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VerbConstruct'
        db.create_table(u'wikipedia_verbconstruct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='verb_1_set', null=True, to=orm['wikipedia.Concept'])),
            ('verb', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Verb'])),
            ('concept2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='verb_2_set', null=True, to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['VerbConstruct'])


    def backwards(self, orm):
        # Deleting model 'VerbConstruct'
        db.delete_table(u'wikipedia_verbconstruct')
