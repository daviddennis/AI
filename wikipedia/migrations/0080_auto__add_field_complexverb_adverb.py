...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComplexVerb.adverb'
        db.add_column(u'wikipedia_complexverb', 'adverb',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cverb_adverb_set', null=True, to=orm['wikipedia.Adverb']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComplexVerb.adverb'
        db.delete_column(u'wikipedia_complexverb', 'adverb_id')
