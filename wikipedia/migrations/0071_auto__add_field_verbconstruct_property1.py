...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.property1'
        db.add_column(u'wikipedia_verbconstruct', 'property1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vc_prop_1_set', null=True, to=orm['wikipedia.Property']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.property1'
        db.delete_column(u'wikipedia_verbconstruct', 'property1_id')
