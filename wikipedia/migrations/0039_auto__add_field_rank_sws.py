...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Rank.sws'
        db.add_column(u'wikipedia_rank', 'sws',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.StopwordSequence'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Rank.sws'
        db.delete_column(u'wikipedia_rank', 'sws_id')
