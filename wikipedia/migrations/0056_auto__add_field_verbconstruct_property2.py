...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.property2'
        db.add_column(u'wikipedia_verbconstruct', 'property2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vc_prop_2_set', null=True, to=orm['wikipedia.Property']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.property2'
        db.delete_column(u'wikipedia_verbconstruct', 'property2_id')
