...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.assertion2'
        db.add_column(u'wikipedia_verbconstruct', 'assertion2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vc_adj_2_set', null=True, to=orm['wikipedia.Adjective']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.assertion2'
        db.delete_column(u'wikipedia_verbconstruct', 'assertion2_id')
