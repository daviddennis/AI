...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Assertion.concept1'
        db.alter_column(u'wikipedia_assertion', 'concept1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Concept']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Assertion.concept1'
        raise RuntimeError("Cannot reverse this migration. 'Assertion.concept1' and its values cannot be restored.")
