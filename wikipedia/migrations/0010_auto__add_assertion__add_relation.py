...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wikipedia_assertion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('relation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Relation'])),
            ('concept1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assertion_1_set', to=orm['wikipedia.Concept'])),
            ('concept2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assertion_2_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Assertion'])

        # Adding model 'Relation'
        db.create_table(u'wikipedia_relation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal(u'wikipedia', ['Relation'])


    def backwards(self, orm):
        # Deleting model 'Assertion'
        db.delete_table(u'wikipedia_assertion')

        # Deleting model 'Relation'
        db.delete_table(u'wikipedia_relation')
