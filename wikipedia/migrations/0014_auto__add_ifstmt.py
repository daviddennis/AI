...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'IfStmt'
        db.create_table(u'wikipedia_ifstmt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vc1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='if_1_set', null=True, to=orm['wikipedia.VerbConstruct'])),
            ('assertion1', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='if_1_ass_set', null=True, to=orm['wikipedia.Assertion'])),
            ('vc2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='if_2_set', null=True, to=orm['wikipedia.VerbConstruct'])),
            ('assertion2', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='if_2_ass_set', null=True, to=orm['wikipedia.Assertion'])),
        ))
        db.send_create_signal(u'wikipedia', ['IfStmt'])


    def backwards(self, orm):
        # Deleting model 'IfStmt'
        db.delete_table(u'wikipedia_ifstmt')
