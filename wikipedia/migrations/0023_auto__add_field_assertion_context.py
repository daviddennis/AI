...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assertion.context'
        db.add_column(u'wikipedia_assertion', 'context',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='assertion_context_set', null=True, to=orm['wikipedia.Context']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assertion.context'
        db.delete_column(u'wikipedia_assertion', 'context_id')
