...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wikipedia_context', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='context_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Context'])


    def backwards(self, orm):
        # Deleting model 'Context'
        db.delete_table(u'wikipedia_context')
