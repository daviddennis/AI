...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rank'
        db.create_table(u'wikipedia_rank', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_instance', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rank_set', to=orm['wikipedia.GroupInstance'])),
            ('rank', self.gf('django.db.models.fields.IntegerField')()),
            ('adjective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Adjective'], null=True, blank=True)),
        ))
        db.send_create_signal(u'wikipedia', ['Rank'])

        # Deleting field 'GroupInstance.rank'
        db.delete_column(u'wikipedia_groupinstance', 'rank')


    def backwards(self, orm):
        # Deleting model 'Rank'
        db.delete_table(u'wikipedia_rank')

        # Adding field 'GroupInstance.rank'
        db.add_column(u'wikipedia_groupinstance', 'rank',
    ...
    models = {
        ...
        u'wikipedia.rank': {
            ...
            'adjective': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wikipedia.Adjective']", 'null': 'True', 'blank': 'True'}),
