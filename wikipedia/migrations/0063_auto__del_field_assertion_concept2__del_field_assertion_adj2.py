...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Assertion.concept2'
        db.delete_column(u'wikipedia_assertion', 'concept2_id')

        # Deleting field 'Assertion.adj2'
        db.delete_column(u'wikipedia_assertion', 'adj2_id')


    def backwards(self, orm):
        # Adding field 'Assertion.concept2'
        db.add_column(u'wikipedia_assertion', 'concept2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='assertion_2_set', null=True, to=orm['wikipedia.Concept'], blank=True),
                      keep_default=False)

        # Adding field 'Assertion.adj2'
        db.add_column(u'wikipedia_assertion', 'adj2',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='adj_2_set', null=True, to=orm['wikipedia.Adjective'], blank=True),
                      keep_default=False)
