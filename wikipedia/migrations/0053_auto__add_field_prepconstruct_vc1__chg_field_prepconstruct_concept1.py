...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PrepConstruct.vc1'
        db.add_column(u'wikipedia_prepconstruct', 'vc1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pc_vc_1_set', null=True, to=orm['wikipedia.VerbConstruct']),
                      keep_default=False)


        # Changing field 'PrepConstruct.concept1'
        db.alter_column(u'wikipedia_prepconstruct', 'concept1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Concept']))

    def backwards(self, orm):
        # Deleting field 'PrepConstruct.vc1'
        db.delete_column(u'wikipedia_prepconstruct', 'vc1_id')


        # User chose to not deal with backwards NULL issues for 'PrepConstruct.concept1'
        raise RuntimeError("Cannot reverse this migration. 'PrepConstruct.concept1' and its values cannot be restored.")
