...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field assertions on 'AssertionValue'
        db.create_table(u'wikipedia_assertionvalue_assertions', (
        ...
        db.create_unique(u'wikipedia_assertionvalue_assertions', ['assertionvalue_id', 'assertion_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field assertions on 'AssertionValue'
        db.delete_table('wikipedia_assertionvalue_assertions')
