...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sense'
        db.create_table(u'wikipedia_sense', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sense_c_set', to=orm['wikipedia.Concept'])),
            ('sense_concept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sense_sense_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Sense'])


    def backwards(self, orm):
        # Deleting model 'Sense'
        db.delete_table(u'wikipedia_sense')
