...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjective.superlative'
        db.add_column(u'wikipedia_adjective', 'superlative',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjective.superlative'
        db.delete_column(u'wikipedia_adjective', 'superlative')
