...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Verb.participle_name'
        db.add_column(u'wikipedia_verb', 'participle_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Verb.participle_name'
        db.delete_column(u'wikipedia_verb', 'participle_name')
