...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Name'
        db.create_table(u'wikipedia_name', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_c_set', null=True, to=orm['wikipedia.Concept'])),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_e_set', null=True, to=orm['wikipedia.Entity'])),
            ('prep_construct', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_pc_set', null=True, to=orm['wikipedia.PrepConstruct'])),
            ('verb_construct', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_vc_set', null=True, to=orm['wikipedia.VerbConstruct'])),
            ('group_instance', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='name_gi_set', null=True, to=orm['wikipedia.GroupInstance'])),
        ))
        db.send_create_signal(u'wikipedia', ['Name'])


    def backwards(self, orm):
        # Deleting model 'Name'
        db.delete_table(u'wikipedia_name')
