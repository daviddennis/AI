...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PrepConstruct.property1'
        db.add_column(u'wikipedia_prepconstruct', 'property1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pc_prop_1_set', null=True, to=orm['wikipedia.Property']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'wikipedia_definition', (
            ('ass', self.gf('django.db.models.fields.related.ForeignKey')(related_name='def_ass_set', null=True, to=orm['wikipedia.Assertion'], blank=True)),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Concept'])),
            ('vc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='def_vc_set', null=True, to=orm['wikipedia.VerbConstruct'], blank=True)),
            ('prop', self.gf('django.db.models.fields.related.ForeignKey')(related_name='def_prop_set', null=True, to=orm['wikipedia.Assertion'], blank=True)),
            ('pc', self.gf('django.db.models.fields.related.ForeignKey')(related_name='def_pc_set', null=True, to=orm['wikipedia.PrepConstruct'], blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'wikipedia', ['Definition'])

        # Deleting field 'PrepConstruct.property1'
        db.delete_column(u'wikipedia_prepconstruct', 'property1_id')
