...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComplexVerb.preposition'
        db.alter_column(u'wikipedia_complexverb', 'preposition_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Preposition'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ComplexVerb.preposition'
        raise RuntimeError("Cannot reverse this migration. 'ComplexVerb.preposition' and its values cannot be restored.")
    ...
    models = {
        ...
        u'wikipedia.complexverb': {
            ...
            'adverb': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cverb_adverb_set'", 'null': 'True', 'to': u"orm['wikipedia.Adverb']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'preposition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wikipedia.Preposition']", 'null': 'True', 'blank': 'True'}),
        ...
        u'wikipedia.group': {
            ...
            'quantifier': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['wikipedia.Quantifier']", 'null': 'True', 'blank': 'True'}),
        ...
        u'wikipedia.name': {
            ...
            'prop': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'name_prop_set'", 'null': 'True', 'to': u"orm['wikipedia.Property']"}),
        ...
        u'wikipedia.prepconstruct': {
            ...
            'property1': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'pc_prop_1_set'", 'null': 'True', 'to': u"orm['wikipedia.Property']"}),
        ...
        u'wikipedia.sense': {
            'Meta': {'object_name': 'Sense'},
            'concept': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sense_c_set'", 'to': u"orm['wikipedia.Concept']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sense_concept': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sense_sense_set'", 'to': u"orm['wikipedia.Concept']"})
        },
