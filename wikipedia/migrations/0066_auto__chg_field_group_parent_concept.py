...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.parent_concept'
        db.alter_column(u'wikipedia_group', 'parent_concept_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Concept']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Group.parent_concept'
        raise RuntimeError("Cannot reverse this migration. 'Group.parent_concept' and its values cannot be restored.")
