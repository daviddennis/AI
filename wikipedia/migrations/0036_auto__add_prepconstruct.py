...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrepConstruct'
        db.create_table(u'wikipedia_prepconstruct', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('concept1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pc_1_set', to=orm['wikipedia.Concept'])),
            ('preposition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Preposition'])),
            ('concept2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pc_2_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['PrepConstruct'])


    def backwards(self, orm):
        # Deleting model 'PrepConstruct'
        db.delete_table(u'wikipedia_prepconstruct')
