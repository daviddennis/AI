...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.parent_vc'
        db.add_column(u'wikipedia_property', 'parent_vc',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.VerbConstruct'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'Property.parent'
        db.alter_column(u'wikipedia_property', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Concept']))

    def backwards(self, orm):
        # Deleting field 'Property.parent_vc'
        db.delete_column(u'wikipedia_property', 'parent_vc_id')


        # User chose to not deal with backwards NULL issues for 'Property.parent'
        raise RuntimeError("Cannot reverse this migration. 'Property.parent' and its values cannot be restored.")
