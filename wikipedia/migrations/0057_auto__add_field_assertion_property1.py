...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assertion.property1'
        db.add_column(u'wikipedia_assertion', 'property1',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ass_prop_1_set', null=True, to=orm['wikipedia.Property']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assertion.property1'
        db.delete_column(u'wikipedia_assertion', 'property1_id')
