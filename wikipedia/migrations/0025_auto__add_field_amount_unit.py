...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Amount.unit'
        db.add_column(u'wikipedia_amount', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='unit_set', null=True, to=orm['wikipedia.Concept']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Amount.unit'
        db.delete_column(u'wikipedia_amount', 'unit_id')
