...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Amount'
        db.create_table(u'wikipedia_amount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('number', self.gf('django.db.models.fields.FloatField')()),
            ('concept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='amount_set', to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Amount'])


    def backwards(self, orm):
        # Deleting model 'Amount'
        db.delete_table(u'wikipedia_amount')
