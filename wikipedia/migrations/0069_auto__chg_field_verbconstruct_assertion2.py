...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VerbConstruct.assertion2'
        db.alter_column(u'wikipedia_verbconstruct', 'assertion2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Assertion']))

    def backwards(self, orm):

        # Changing field 'VerbConstruct.assertion2'
        db.alter_column(u'wikipedia_verbconstruct', 'assertion2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['wikipedia.Adjective']))
