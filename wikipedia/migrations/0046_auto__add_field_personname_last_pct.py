...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonName.last_pct'
        db.add_column(u'wikipedia_personname', 'last_pct',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonName.last_pct'
        db.delete_column(u'wikipedia_personname', 'last_pct')
