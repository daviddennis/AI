...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Adjective.form'
        db.add_column(u'wikipedia_adjective', 'form',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Adjective.form'
        db.delete_column(u'wikipedia_adjective', 'form')


    models = {
        u'wikipedia.adjective': {
            'Meta': {'object_name': 'Adjective'},
            'form': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
