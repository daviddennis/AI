...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StopwordSequence'
        db.create_table('wikipedia_stopwordsequence', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('string', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ))
        db.send_create_signal('wikipedia', ['StopwordSequence'])


    def backwards(self, orm):
        # Deleting model 'StopwordSequence'
        db.delete_table('wikipedia_stopwordsequence')
