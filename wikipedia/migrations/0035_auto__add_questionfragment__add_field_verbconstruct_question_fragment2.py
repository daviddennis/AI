...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionFragment'
        db.create_table(u'wikipedia_questionfragment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('q_word', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('verb_construct', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.VerbConstruct'])),
        ))
        db.send_create_signal(u'wikipedia', ['QuestionFragment'])

        # Adding field 'VerbConstruct.question_fragment2'
        db.add_column(u'wikipedia_verbconstruct', 'question_fragment2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='qf_2_set', null=True, to=orm['wikipedia.QuestionFragment']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuestionFragment'
        db.delete_table(u'wikipedia_questionfragment')

        # Deleting field 'VerbConstruct.question_fragment2'
        db.delete_column(u'wikipedia_verbconstruct', 'question_fragment2_id')
