...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'wikipedia_property', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prop_parent_set', to=orm['wikipedia.Concept'])),
            ('key_concept', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prop_key_set', to=orm['wikipedia.Concept'])),
            ('value_concept', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='prop_value_set', null=True, to=orm['wikipedia.Concept'])),
        ))
        db.send_create_signal(u'wikipedia', ['Property'])


    def backwards(self, orm):
        # Deleting model 'Property'
        db.delete_table(u'wikipedia_property')
