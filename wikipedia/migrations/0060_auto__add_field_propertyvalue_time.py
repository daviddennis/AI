...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PropertyValue.time'
        db.add_column(u'wikipedia_propertyvalue', 'time',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PropertyValue.time'
        db.delete_column(u'wikipedia_propertyvalue', 'time')
