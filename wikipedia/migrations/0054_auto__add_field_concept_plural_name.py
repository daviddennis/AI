...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Concept.plural_name'
        db.add_column(u'wikipedia_concept', 'plural_name',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Concept.plural_name'
        db.delete_column(u'wikipedia_concept', 'plural_name')
