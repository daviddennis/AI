...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionFragment.prep_construct'
        db.add_column(u'wikipedia_questionfragment', 'prep_construct',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.PrepConstruct'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'QuestionFragment.verb_construct'
        db.alter_column(u'wikipedia_questionfragment', 'verb_construct_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.VerbConstruct'], null=True))
        # Adding M2M table for field qf_s on 'Category'
        db.create_table(u'wikipedia_category_qf_s', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('category', models.ForeignKey(orm[u'wikipedia.category'], null=False)),
            ('questionfragment', models.ForeignKey(orm[u'wikipedia.questionfragment'], null=False))
        ))
        db.create_unique(u'wikipedia_category_qf_s', ['category_id', 'questionfragment_id'])


    def backwards(self, orm):
        # Deleting field 'QuestionFragment.prep_construct'
        db.delete_column(u'wikipedia_questionfragment', 'prep_construct_id')


        # User chose to not deal with backwards NULL issues for 'QuestionFragment.verb_construct'
        raise RuntimeError("Cannot reverse this migration. 'QuestionFragment.verb_construct' and its values cannot be restored.")
        # Removing M2M table for field qf_s on 'Category'
        db.delete_table('wikipedia_category_qf_s')
