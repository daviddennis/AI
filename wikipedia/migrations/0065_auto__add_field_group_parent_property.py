...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.parent_property'
        db.add_column(u'wikipedia_group', 'parent_property',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wikipedia.Property'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.parent_property'
        db.delete_column(u'wikipedia_group', 'parent_property_id')
