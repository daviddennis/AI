...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VerbConstruct.context'
        db.add_column(u'wikipedia_verbconstruct', 'context',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='verb_context_set', null=True, to=orm['wikipedia.Context']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VerbConstruct.context'
        db.delete_column(u'wikipedia_verbconstruct', 'context_id')
